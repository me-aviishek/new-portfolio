...
function About() {
  ...
  <motion.div initial={{
    ...
    I am a passionate individual currently immersed in the world of data science and full-stack web development. Currently pursuing my education in Data Science(Bsc) at IIT Madras and B.Tech(CSE) from LPU. My journey also includes a deep dive into the realm of competitive programming, where I constantly challenge myself to solve complex problems and enhance my problem-solving skills.
<br/><br/>
